...
> Generated for platform release **v2026.7.19** -- do not edit by hand.
...
for img in \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-27T10-51-13Z.2393; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-27T10-51-13Z.2393` (asserted available on both registries at release time).
