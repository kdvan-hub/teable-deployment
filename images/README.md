...
> Generated for platform release **v2026.8.4** -- do not edit by hand.
...
for img in \
    ...
    ghcr.io/teableio/teable-sandbox-agent:release.2026-07-30T06-45-38Z.2429; do
  docker pull "$img"
...
`ghcr.io/teableio/teable-sandbox-agent:release.2026-07-30T06-45-38Z.2429` (asserted available on both registries at release time).
